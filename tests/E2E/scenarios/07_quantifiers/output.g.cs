...
namespace QuantifierDemo
{
    public static class QuantifierDemoModule
    {
        ...
        public static bool ExistsTarget(int target)
        {
            ...
            if (!((__result__ == true))) throw new Calor.Runtime.ContractViolationException("Postcondition failed: (__result__ == true)", "f002", Calor.Runtime.ContractKind.Ensures, startOffset: 290, length: 19, sourceFile: null, line: 14, column: 3, condition: "(__result__ == true)");
            return __result__;
        }

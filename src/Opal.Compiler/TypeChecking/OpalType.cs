...
/// <summary>
/// Base class for all OPAL types.
/// </summary>
public abstract class OpalType : IEquatable<OpalType>
{
    public abstract string Name { get; }

    public abstract bool Equals(OpalType? other);
    public override bool Equals(object? obj) => obj is OpalType other && Equals(other);
    public abstract override int GetHashCode();
    public override string ToString() => Name;

    public static bool operator ==(OpalType? left, OpalType? right)
        => ReferenceEquals(left, right) || (left?.Equals(right) ?? false);
    public static bool operator !=(OpalType? left, OpalType? right) => !(left == right);
}

/// <summary>
/// Represents primitive types (INT, FLOAT, BOOL, STRING, VOID).
/// </summary>
public sealed class PrimitiveType : OpalType
{
    ...
    public override bool Equals(OpalType? other)
...
/// </summary>
public sealed class OptionType : OpalType
{
    public OpalType InnerType { get; }
    public override string Name => $"Option<{InnerType.Name}>";

    public OptionType(OpalType innerType)
    {
...
/// </summary>
public sealed class ResultType : OpalType
{
    public OpalType OkType { get; }
    public OpalType ErrType { get; }
    public override string Name => $"Result<{OkType.Name}, {ErrType.Name}>";

    public ResultType(OpalType okType, OpalType errType)
    {
...
/// </summary>
public sealed class RecordType : OpalType
{
    public override string Name { get; }
...
public sealed class RecordField
{
    ...
    public OpalType Type { get; }
    public bool HasDefault { get; }

    public RecordField(string name, OpalType type, bool hasDefault = false)
    {
        Name = name ?? throw new ArgumentNullException(nameof(name));
...
/// </summary>
public sealed class UnionType : OpalType
{
    public override string Name { get; }
...
/// </summary>
public sealed class FunctionType : OpalType
{
    public IReadOnlyList<OpalType> ParameterTypes { get; }
    public OpalType ReturnType { get; }
    ...
    public FunctionType(IReadOnlyList<OpalType> parameterTypes, OpalType returnType)
    {
...
/// </summary>
public sealed class ErrorType : OpalType
{
    ...
    public override bool Equals(OpalType? other) => other is ErrorType;
...
/// </summary>
public sealed class TypeVariable : OpalType
{
    private static int _counter;

    public int Id { get; }
    public OpalType? ResolvedType { get; private set; }
    ...
    public void Resolve(OpalType type)
    {

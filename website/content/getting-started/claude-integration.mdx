...
Convert src/Services/PaymentService.cs to OPAL
```
...
- [Adding OPAL to Existing Projects](/guides/adding-opal-to-existing-projects/) - Migration guide
- [opalc init](/cli/init/) - Full init command documentation
- [Benchmarking](/benchmarking/) - See how OPAL compares to C#

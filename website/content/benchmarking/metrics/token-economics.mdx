...
The 0.63x ratio means Calor uses ~1.6x more tokens than C# on average.
...
- [Information Density](/benchmarking/metrics/information-density/) - Semantic content per token

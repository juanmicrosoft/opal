...
The 0.09x ratio seems dramatic, but consider:
...
The 0.09x ratio reflects Calor's design choice to prioritize explicit semantics over token efficiency.
...
- [Results](/benchmarking/results/) - Summary of all metrics
- [Tradeoffs](/philosophy/tradeoffs/) - Understanding the design decisions

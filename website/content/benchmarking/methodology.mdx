...
These metrics explain why Calor achieves **1.12x overall advantage** despite losing on token efficiency: the semantic verification pipeline catches classes of bugs that syntax-only tools cannot detect.
